...
// BNES Override: Always enable drag-and-drop extension installation,
// regardless of developer mode state. Upstream gates drag-enabled on
// inDevMode, which prevents CRX/ZIP drag install when dev mode is off.
...
<extensions-drop-overlay drag-enabled="true">
