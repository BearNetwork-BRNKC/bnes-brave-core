...
const UpdateEmailTestCase* UpdateEmailAuthenticationTokenFailedToDecrypt() {
  static const base::NoDestructor<UpdateEmailTestCase> kTestCase({
      .test_name = "update_email_authentication_token_failed_to_decrypt",
...
const UpdateEmailTestCase* UpdateEmailSuccessNoBody() {
  static const base::NoDestructor<UpdateEmailTestCase> kTestCase({
      .test_name = "update_email_success_no_body",
...
const UpdateEmailTestCase* UpdateEmailSuccessEmailEmpty() {
  static const base::NoDestructor<UpdateEmailTestCase> kTestCase({
      .test_name = "update_email_success_email_empty",
      .fail_decryption = false,
      .endpoint_response = {{.net_error = net::OK,
                             .status_code = net::HTTP_OK,
                             .body =
...
const UpdateEmailTestCase* UpdateEmailUnauthorized() {
  static const base::NoDestructor<UpdateEmailTestCase> kTestCase({
      .test_name = "update_email_unauthorized",
      .fail_decryption = false,
      .endpoint_response = {{.net_error = net::OK,
...
const UpdateEmailTestCase* UpdateEmailForbidden() {
  static const base::NoDestructor<UpdateEmailTestCase> kTestCase({
      .test_name = "update_email_forbidden",
      .fail_decryption = false,
      .endpoint_response = {{.net_error = net::OK,
...
const UpdateEmailTestCase* UpdateEmailInternalServerError() {
  static const base::NoDestructor<UpdateEmailTestCase> kTestCase({
      .test_name = "update_email_internal_server_error",
      .fail_decryption = false,
      .endpoint_response = {{.net_error = net::OK,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(UpdateEmailAuthenticationTokenFailedToDecrypt(),
                    UpdateEmailSuccessNoBody(),
                    UpdateEmailSuccessEmailEmpty(),
                    UpdateEmailSuccess(),
                    UpdateEmailUnauthorized(),
                    UpdateEmailForbidden(),
                    UpdateEmailInternalServerError()),
