...
extension Strings.Shields {
  ...
  public static let customScriptletInvalidNameError = NSLocalizedString(
    ...
    bundle: .module,
    value:
      "The scriptlet name must start with `%@`, end with `%@` and cannot contain `/`, `:` or `..`",
    comment:
      "An error message telling the user that the name they gave their custom scriptlet is invalid. %@ are the required prefix (`user-`) and file extension (`.js`)"
  )
